  ...
  try {
    ...
    const mailOptions = {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Silakan login menggunakan kredensial di atas melalui tautan berikut:</p>
        <p><a href="${process.env.FRONTEND_URL}/login" style="color: #3498db;">Login ke Bimbel Galaksi</a></p>
